...
<template>
  <div
    class="absolute right-0 mt-6 w-80 bg-blue-50 rounded-md shadow-lg overflow-hidden z-50 border border-gray-200"
  >
    <div class="p-4 border-b border-gray-200 flex justify-between items-center">
      <h3 class="text-lg font-medium text-black">Notifications</h3>
      <button
        @click="handleClearAll"
        class="text-sm text-blue-800 disabled:text-gray-400 cursor-pointer hover:text-black"
